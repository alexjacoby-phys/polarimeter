...
index1 = DelimitedFiles.readdlm("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/peaks/Estimated_Angles.txt")
...
# index3 = DelimitedFiles.readdlm("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/peaks/exact_angles.txt")
...
# Plots.plot!(ticks, -index3[3,:], label = "Phase Slope 2", linestyle = :dash);
...
sum([av3[i+1] - av3[i] for i in 1:(length(av2)-1)]) / (length(av3) - 1)
