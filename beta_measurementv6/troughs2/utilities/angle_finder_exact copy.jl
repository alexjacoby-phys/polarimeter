...
γ = (67.5) * (π / 180)
# begin
raw_imagepr = Images.Gray.(Images.load(string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv6/troughs2/troughs2_png/", small_fn, ".png")))

raw_image = OffsetArrays.centered(ImageTransformations.imrotate(raw_imagepr, γ))[-100:200, -100:400]
...
correction_image = OffsetArrays.centered(ImageTransformations.imrotate(correction_imagepr, γ))[-100:200, -100:400]
...
θ = 0 * (π / 180) #1.48 *(π / 180)(N, M) = size(image)
LX = M - 1
LY = N - 1
#Aspect = 1.2
#Aspect = 2.5
