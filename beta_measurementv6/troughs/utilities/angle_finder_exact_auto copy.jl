...
for (α, small_fn) in pairs(small_fn_vec)
    ...
    Plots.savefig(string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/peaks/Phase_Slope_Figs/", small_fn, ".pdf"))
...
DelimitedFiles.writedlm("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/peaks/exact_angles.txt", [small_fn_vec, final_angle_vec, final_angle_vec_deg])
