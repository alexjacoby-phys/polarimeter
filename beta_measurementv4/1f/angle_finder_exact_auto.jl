...
for (α, small_fn) in pairs(small_fn_vec)
    γ = -9 * (π / 180)
    begin
        raw_imagepr = Images.Gray.(Images.load(string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4/1f/1f_png/", small_fn, ".png")))
    ...
    Plots.savefig(string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4/1f/Phase_Slope_Figs/", small_fn, ".pdf"))
...
DelimitedFiles.writedlm("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4/1f/exact_angles.txt", [small_fn_vec, final_angle_vec, final_angle_vec_deg])
