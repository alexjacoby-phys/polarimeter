...
for small_fn in small_fn_vec
    cd("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv3-2/1f")
    fn = string("//Volumes/AJACOBY/beta_measurementv3/1f/", small_fn)
...
Plots.plot(ϕ_vec)
DelimitedFiles.writedlm("angle_estimate.txt", [small_fn_vec, ϕ_vec])
...
#extra angle finder
small_fn = "0"
cd("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv3/1f")
fn = string("//Volumes/AJACOBY/beta_measurementv3/1f/", small_fn)
