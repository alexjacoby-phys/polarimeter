...
small_fn_vec = [string("-", i) for i in 21:30]
#vcat([string("+",i) for i in 1:10], ["0"], [string("-",i) for i in 1:10])


for small_fn in small_fn_vec

    fn = string("//Volumes/AJACOBY/1f_alignment_25.9.23/", small_fn)
...
fn = string("//Volumes/AJACOBY/1f_alignment_25.9.23/-", 20)
