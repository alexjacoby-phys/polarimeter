...
for number in 4:30
    fn = string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv2/1f/", number, ".txt")
    begin
...
Plots.plot(4:30,list1);
Plots.plot!(4:30,list2)
