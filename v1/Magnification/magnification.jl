...
for i in 1:100
    ...
    begin
        ...
        fwhm_pre = abs.(density .- 0.5)
        fwhm_upper_ind = findmin(fwhm_pre[peak_ind:length(fwhm_pre)])[2][1]+peak_ind -1
        fwhm_lower_ind = findmin(fwhm_pre[1:peak_ind])[2][1]
        fwhm = k_rng[fwhm_upper_ind] - k_rng[fwhm_lower_ind]
        append!(fwhm_vec,fwhm)
    ...
    k_fit_rng = k_rng[fwhm_lower_ind]:(10e-5):k_rng[fwhm_upper_ind]
