...
dat = DelimitedFiles.readdlm("angle_data.txt")


Plots.plot(dat[:,1]*0.06,dat[:,2],xlabel = "Relative Angle from Micrometer (Degrees)",ylabel = "Calculated Absolute Angle (Degrees)",legend = :none, linewidth = 2.)
Plots.savefig("angle_benchmark1.pdf")
