...
for (α, small_fn) in pairs(small_fn_vec)
    begin
        γ = -32.0 * (π / 180)
        raw_imagepr = Images.Gray.(Images.load(string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/troughs/troughs_png/", small_fn, ".png")))
    ...
    Plots.savefig(string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/troughs/Phase_Slope_Figs/", small_fn,".pdf"))
...
DelimitedFiles.writedlm("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/troughs/exact_angles.txt", [small_fn_vec, final_angle_vec, final_angle_vec_deg])

Plots.plot(final_angle_vec_deg)

estimated_index = DelimitedFiles.readdlm("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/troughs/Estimated_Angles.txt")


Plots.plot(- final_angle_vec_deg);
Plots.plot!(estimated_index[3,:])
