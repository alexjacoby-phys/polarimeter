...
for (α, small_fn) in pairs(small_fn_vec)
    γ = -9 * (π / 180)
    begin
        raw_imagepr = Images.Gray.(Images.load(string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/1f/1f_png/", small_fn, ".png")))

        raw_image = OffsetArrays.centered(ImageTransformations.imrotate(raw_imagepr, γ))[-340:150, -10:600]
        dat = Float64.(raw_image)

        correction_imagepr = Images.Gray.(Images.load("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/background_mid_intensity.png"))
        correction_image = OffsetArrays.centered(ImageTransformations.imrotate(correction_imagepr, γ))[-340:150, -10:600]
    ...
    for θ in θ_vec
        ...
        p0 = [0.0, 0]
        linear_fit1 = LsqFit.curve_fit(linear_model, Vector{Float64}(1:partitions), params[:, 4], p0)
    ...
    Plots.savefig(string("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/1f/Phase_Slope_Figs/", small_fn, ".pdf"))
...
DelimitedFiles.writedlm("/Users/alexjacoby/Documents/Research_Code/polarimeter/beta_measurementv4-2/1f/exact_angles.txt", [small_fn_vec, final_angle_vec, final_angle_vec_deg])
